...
int main(int argc, char** argv){
	...
	char* pEnd;
//	float prob = 0.6;
//	float prob = strtol(argv[2],&pEnd,10);
//	cout<<"Prob:"<<prob<<endl;
	...
	float prob = std::stof(fs);//this is much better way to do it
	cout<<"Prob:"<<prob<<endl;

	int cycles = 4;
	cycles = strtol(argv[3],&pEnd,10);
...
/*Assignment-10: Modeling of the cache as a HIT or MISS transaction along with dependance on 2 parameters x (HIT probability)
				 and N (number of cycles required for further execution)*/		
